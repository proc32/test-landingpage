...
(() => {
    ...
    const i = n(n({}, t), {}, { siteUrl: "https://www.templatemonster.com/", settings: { tm: { cookieDomain: ".templatemonster.com", setSettingsFunc: t.setSettings.tm }, blog: { cookieDomain: ".monsterspost.com", setSettingsFunc: t.setSettings.tm }, one: { cookieDomain: ".monsterone.com", setSettingsFunc: t.setSettings.one } }, serviceUsers: "//users.templatemonster.com/api/v1/", serviceGeo: "//api.templatemonster.com/geo/v1/" });
    ...
    function u() {
        ...
        var t = {},
            e = Object.prototype,
            r = e.hasOwnProperty,
            n = Object.defineProperty || function(t, e, r) { t[e] = r.value },
        ...
        function x(t, e) {
            function o(n, i, c, u) {
                ...
                if ("throw" !== l.type) {
                    var s = l.arg,
                        f = s.value;
                    return f && "object" == a(f) && r.call(f, "__await") ? e.resolve(f.__await).then((function(t) { o("next", t, c, u) }), (function(t) { o("throw", t, c, u) })) : e.resolve(f).then((function(t) { s.value = t, c(s) }), (function(t) { return o("throw", t, c, u) }))
                }
                u(l.arg)
            }
            var i;
        ...
        function E(t, e, r) {
            ...
            return function(o, i) {
                ...
                for (r.method = o, r.arg = i;;) {
                    var a = r.delegate;
                    if (a) { var c = S(a, r); if (c) { if (c === p) continue; return c } }
        ...
        function j(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(_, this), this.reset(!0) }
        ...
        return d.prototype = v, n(b, "constructor", { value: v, configurable: !0 }), n(v, "constructor", { value: d, configurable: !0 }), d.displayName = s(v, l, "GeneratorFunction"), t.isGeneratorFunction = function(t) { var e = "function" == typeof t && t.constructor; return !!e && (e === d || "GeneratorFunction" === (e.displayName || e.name)) }, t.mark = function(t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, v) : (t.__proto__ = v, s(t, l, "GeneratorFunction")), t.prototype = Object.create(b), t }, t.awrap = function(t) { return { __await: t } }, L(x.prototype), s(x.prototype, c, (function() { return this })), t.AsyncIterator = x, t.async = function(e, r, n, o, i) { void 0 === i && (i = Promise); var a = new x(f(e, r, n, o), i); return t.isGeneratorFunction(r) ? a : a.next().then((function(t) { return t.done ? t.value : a.next() })) }, L(b), s(b, l, "Generator"), s(b, i, (function() { return this })), s(b, "toString", (function() { return "[object Generator]" })), t.keys = function(t) {
            var e = Object(t),
                r = [];
            ...
            delegateYield: function(t, e, r) { return this.delegate = { iterator: k(t), resultName: e, nextLoc: r }, "next" === this.method && (this.arg = void 0), p }
        }, t
    }
    ...
    var v = function() {
            ...
            var r = p("cp"),
                ...
                a = null == n ? void 0 : n.a,
                c = null == n ? void 0 : n.t;
            d("consent", t, { ad_storage: o || c ? "granted" : "denied", ad_user_data: o || c ? "granted" : "denied", ad_personalization: o || c ? "granted" : "denied", analytics_storage: o || a ? "granted" : "denied", functionality_storage: o || i || a ? "granted" : "denied", personalization_storage: o || i || a ? "granted" : "denied", security_storage: "granted" }), "update" === t && window.dataLayer.push({ event: "consent_updated" })
        },
        m = function() {
        ...
        g = function() {
            var t = s(u().mark((function t() {
                ...
                return u().wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            if (e = p("country_code"), r = "", !e) { t.next = 6; break }
                            r = e, t.next = 16;
                            break;
                        case 6:
                        ...
                        case 16:
                            o = Object.keys(i.countriesEurope), a = null == o ? void 0 : o.find((function(t) { return t === r })), d("consent", "default", { ad_storage: c = a ? "denied" : "granted", ad_user_data: c, ad_personalization: c, analytics_storage: c, functionality_storage: c, personalization_storage: c, security_storage: "granted" });
                        case 20:
                        case "end":
                            return t.stop()
                    }
    ...
    function b() {
        ...
        function s(t, e, r) { try { return { type: "normal", arg: t.call(e, r) } } catch (t) { return { type: "throw", arg: t } } }
        t.wrap = l;
        var f = {};
        ...
        function x(t, e) {
            function o(n, i, a, c) {
                ...
                if ("throw" !== u.type) {
                    var l = u.arg,
                        f = l.value;
                    return f && "object" == w(f) && r.call(f, "__await") ? e.resolve(f.__await).then((function(t) { o("next", t, a, c) }), (function(t) { o("throw", t, a, c) })) : e.resolve(f).then((function(t) { l.value = t, a(l) }), (function(t) { return o("throw", t, a, c) }))
                }
                c(u.arg)
            }
            var i;
        ...
        function E(t, e, r) {
            ...
            return function(o, i) {
                ...
                for (r.method = o, r.arg = i;;) {
                    var a = r.delegate;
                    if (a) { var c = S(a, r); if (c) { if (c === f) continue; return c } }
                    if ("next" === r.method) r.sent = r._sent = r.arg;
                    else if ("throw" === r.method) {
                        if ("suspendedStart" === n) throw n = "completed", r.arg;
                        r.dispatchException(r.arg)
                    ...
                    n = "executing";
                    var u = s(t, e, r);
                    if ("normal" === u.type) { if (n = r.done ? "completed" : "suspendedYield", u.arg === f) continue; return { value: u.arg, done: r.done } }
                    "throw" === u.type && (n = "completed", r.method = "throw", r.arg = u.arg)
                }
            }
        }
        ...
        function P() { return { value: void 0, done: !0 } }
        return p.prototype = y, n(g, "constructor", { value: y, configurable: !0 }), n(y, "constructor", { value: p, configurable: !0 }), p.displayName = u(y, c, "GeneratorFunction"), t.isGeneratorFunction = function(t) { var e = "function" == typeof t && t.constructor; return !!e && (e === p || "GeneratorFunction" === (e.displayName || e.name)) }, t.mark = function(t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : (t.__proto__ = y, u(t, c, "GeneratorFunction")), t.prototype = Object.create(g), t }, t.awrap = function(t) { return { __await: t } }, L(x.prototype), u(x.prototype, a, (function() { return this })), t.AsyncIterator = x, t.async = function(e, r, n, o, i) { void 0 === i && (i = Promise); var a = new x(l(e, r, n, o), i); return t.isGeneratorFunction(r) ? a : a.next().then((function(t) { return t.done ? t.value : a.next() })) }, L(g), u(g, c, "Generator"), u(g, i, (function() { return this })), u(g, "toString", (function() { return "[object Generator]" })), t.keys = function(t) {
            var e = Object(t),
                r = [];
            for (var n in e) r.push(n);
            return r.reverse(),
            ...
            finish: function(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), O(r), f } },
            catch: function(t) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                    var r = this.tryEntries[e];
                    if (r.tryLoc === t) {
            ...
            delegateYield: function(t, e, r) { return this.delegate = { iterator: k(t), resultName: e, nextLoc: r }, "next" === this.method && (this.arg = void 0), f }
        }, t
    }
    ...
    (x = b().mark((function t() {
        ...
        return new Promise((function(r, n) {
            ...
            function i(t) { L(o, r, n, i, a, "next", t) }

            function a(t) { L(o, r, n, i, a, "throw", t) }
            i(void 0)
        }))
    })()
})();